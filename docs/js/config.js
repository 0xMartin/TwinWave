...
const CONFIG = {
    ...
    firmware: {
        ...
        filename: 'MARAUDER-v1.12.1-ESP32-PICO-V3-02.zip',
        // Relative path for web flasher (same-origin)
        localPath: 'firmware/MARAUDER-v1.12.1-ESP32-PICO-V3-02.zip',
        // GitHub releases URL for downloads page
        downloadUrl: 'https://github.com/0xMartin/TwinWave/releases/latest/download/MARAUDER-v1.12.1-ESP32-PICO-V3-02.zip',
    },
